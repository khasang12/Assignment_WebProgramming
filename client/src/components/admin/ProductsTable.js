import { Modal, Box, TextInput, Text, Group, ActionIcon, Button } from '@mantine/core';
...
export function ProductsTable() {
    ...
    useEffect(() => {
        setRecords(
            productList.filter(({ id, name }) => {
                if (
                    debouncedQuery !== '' &&
                    !`${id} ${name}`.toLowerCase().includes(debouncedQuery.trim().toLowerCase())
                ) {
                    return false;
                }
                return true;
    ...
    const deleteProduct = (id) => {
        axios({
            ...
            .then((response) => setProductList((prev) => prev.filter((item) => item.id !== id)))
            .catch((res) => alert(res));
    };
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body gap-5 lh-lg">
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <p class="text-primary m-0 ms-2 me-auto">{values.overall_rating}</p>
                            </div>
                            <div class="d-flex flex-row">
                            ...
                            <div class="d-flex flex-column overflow-visible">
                                ...
                                <p class="text-primary m-0 me-auto overflow-auto w-100">{values.thumbnail}</p>
                            </div>
                            <div class="d-flex flex-column ">
                                <p class="text-secondary m-0">Mô tả:</p>
                                <p class="text-primary m-0 me-auto overflow-visible">{values.description}</p>
                            </div>
                            <hr />
                            <div class="d-flex flex-column">
                            ...
                            <div className="ms-2 py-2">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <p class="text-primary m-0 ms-2 me-auto">{values.screen_tech}</p>
                                </div>
                                <div class="d-flex flex-row">
                                    <p class="text-secondary m-0">Kích thước:</p>
                                    <p class="text-primary m-0 ms-2 me-auto">{values.screen_size}</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <input required type="text" className="form-control" name="price" onChange={handleChange} />
                            ...
                            <input type="text" className="form-control" name="gpu" onChange={handleChange} />
                            <label htmlFor="thumbnail" className="mt-2 form-label">
                                RAM
                            </label>
                            ...
                            <input type="text" className="form-control" name="disk" onChange={handleChange} />
                            <label htmlFor="thumbnail" className="mt-2 form-label">
                                Khối lượng
                            </label>
                            ...
                            <input type="text" className="form-control" name="screen_tech" onChange={handleChange} />
                            <label htmlFor="thumbnail" className="mt-2 form-label">
                                Kích thước
                            </label>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <p className="fs-4 fw-semibold">
                                Xóa sản phẩm <span class="text-danger fw-bold">"{values.name}"</span> ?
                            </p>
