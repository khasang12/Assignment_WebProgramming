                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <Link to={login_signup[2]} className="d-flex flex-column">
                                            <button className="btn btn-light" onClick={checkbutton()}>
                                                {login_signup[3]}
                                            </button>
                                        </Link>
                                    </div>
                                            ...
                                            <div className="accordion-body list-group list-group-flush p-0">
                                                <div className="btn-group dropend">
                                                    ...
                                                    <ul className="dropdown-menu">
                                                        <li>
                                                            <a className="dropdown-item" href="/search?cpu=intel-i3">
                                                                Intel Core i3
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a className="dropdown-item" href="/search?cpu=intel-i5">
                                                                Intel Core i5
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a className="dropdown-item" href="/search?cpu=intel-i7">
                                                                Intel Core i7
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a className="dropdown-item" href="/search?cpu=intel-i9">
                                                                Intel Core i9
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div className="btn-group dropend">
                                                    ...
                                                    <ul className="dropdown-menu">
                                                        <li>
                                                            <a className="dropdown-item" href="/search?cpu=amd-ryzen-3">
                                                                AMD Ryzen 3
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a className="dropdown-item" href="/search?cpu=amd-ryzen-5">
                                                                AMD Ryzen 5
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a className="dropdown-item" href="/search?cpu=amd-ryzen-7">
                                                                AMD Ryzen 7
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a className="dropdown-item" href="/search?cpu=amd-ryzen-9">
                                                                AMD Ryzen 9
                                                            </a>
                                                        </li>
                                                    </ul>
