...
INSERT INTO `Orders` (customer_id,`address`,receiverName,phoneNumber, paymentMethod, create_at, last_update, `status`) VALUE (1,'59/6/12 Nguyễn Đình Chiểu, Phường 4, Quận 3, Thành phố Hồ Chí Minh',     'Minh Vuong', '039768114', 'momo',  '2022-12-01 00:00:00', '2022-12-1','waiting');
INSERT INTO `Orders` (customer_id,`address`,receiverName,phoneNumber, paymentMethod, create_at, last_update, `status`) VALUE (2,'98 Nguyễn Đình Chiểu Dist1, Thành phố Hồ Chí Minh',                      'Minh Vuong', '039768114', 'cash',  '2022-12-01 00:00:00', '2022-12-1','confirmed');
INSERT INTO `Orders` (customer_id,`address`,receiverName,phoneNumber, paymentMethod, create_at, last_update, `status`) VALUE (3,'98 Nguyễn Đình Chiểu Dist1, Thành phố Hồ Chí Minh',                      'Minh Vuong', '039768114', 'cash',  '2022-12-01 00:00:00', '2022-12-1','confirmed');
INSERT INTO `Orders` (customer_id,`address`,receiverName,phoneNumber, paymentMethod, create_at, last_update, `status`) VALUE (4,'K18 Luy Ban Bich Street Tan Thoi Hoa Phường, Thành phố Hồ Chí Minh',     'Tuan Hao',   '039768114', 'qrcode','2022-12-01 00:00:00', '2022-12-1','waiting');
INSERT INTO `Orders` (customer_id,`address`,receiverName,phoneNumber, paymentMethod, create_at, last_update, `status`) VALUE (5,'18 Luy Ban Bich Street Tan Thoi Hoa Phường, Thành phố Hồ Chí Minh',      'Quoc Thai',  '039768114', 'vnpay', '2022-12-01 00:00:00', '2022-12-1','waiting');
INSERT INTO `Orders` (customer_id,`address`,receiverName,phoneNumber, paymentMethod, create_at, last_update, `status`) VALUE (6,'98 Nguyễn Đình Chiểu, Quận 1, Thành phố Hồ Chí Minh',                    'Kha Sang',   '039768114', 'momo',  '2022-12-01 00:00:00', '2022-12-1','confirmed');
INSERT INTO `Orders` (customer_id,`address`,receiverName,phoneNumber, paymentMethod, create_at, last_update, `status`) VALUE (7,'298 Nguyen Trong Tuyen, Phường 1, Thành phố Hồ Chí Minh',                'Kha Sang',   '039768114', 'momo',  '2022-12-01 00:00:00', '2022-12-1','waiting');
INSERT INTO `Orders` (customer_id,`address`,receiverName,phoneNumber, paymentMethod, create_at, last_update, `status`) VALUE (8,'18 Luy Ban Bich Street Tan Thoi Hoa Phường, Thành phố Hồ Chí Minh',      'Kha Sang',   '039768114', 'qrcode','2022-12-01 00:00:00', '2022-12-1','confirmed');
INSERT INTO `Orders` (customer_id,`address`,receiverName,phoneNumber, paymentMethod, create_at, last_update, `status`) VALUE (9,'Ký túc xá khu A, Đường tạ Quang Bửu, khu phố 6, Linh Trung, Thủ Đức',    'Tuan Hao',   '039768114', 'qrcode','2022-12-01 00:00:00', '2022-12-1','confirmed');
INSERT INTO `Orders` (customer_id,`address`,receiverName,phoneNumber, paymentMethod, create_at, last_update, `status`) VALUE (10,'K18 Luy Ban Bich Street Tan Thoi Hoa Phường, Thành phố Hồ Chí Minh',     'Tuan Hao',   '039768114', 'qrcode','2022-12-01 00:00:00', '2022-12-1','waiting');
